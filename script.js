...
function getHumanChoice(choice) {
    ...
    if (choice === rock.value || choice === paper.value || choice === scissor.value) {
        document.getElementById("human").innerHTML="Your choice is: " + choice;
        return choice;
    } else {
...
function getComputerChoice() {
    ...
    document.getElementById("computer").innerHTML="Computer choice is: " + computer_choice;
...
function playRound(humanSelection, computerSelection) {
    if (roundCounter >= 5 ) {
         ...
         document.getElementById("end").innerHTML="You've played 5 rounds. Game Over!";
    ...
    if (humanSelection === computerSelection) {
        ...
        document.getElementById("rule").innerHTML="The Games tie! ";
    } else if (
        ...
        document.getElementById("rule").innerHTML=   humanSelection + " beats " + computerSelection;
        document.getElementById("humanscore").innerHTML="Your's score="+ (humanScore=humanScore+1);
        ...
        document.getElementById("rule").innerHTML= computerSelection+ " beats "+ humanSelection;
        document.getElementById("humanscore").innerHTML="Your's score="+ humanScore ;
        document.getElementById("computerscore").innerHTML="computer's score="+ (computerScore=computerScore+1);
    }
